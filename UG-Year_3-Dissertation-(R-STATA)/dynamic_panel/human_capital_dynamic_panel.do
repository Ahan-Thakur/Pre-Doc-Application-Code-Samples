...
xtabond2 D.ln_human_capital ///
         ...
         gmm(D.institutions_L1_4_avg D.institutions_L5_8_avg D.institutions_L9_12_avg ///
             D.institutions_L13_16_avg D.institutions_L17_20_avg, lag(2 3) collapse) ///
         gmm(L.D.ln_human_capital, lag(2 3) collapse) ///
...
**Average Lag 17-20 of institutions, 1 lag of human capital 
...
xtabond2 D.ln_human_capital ///
         ...
         gmm(L.D.ln_human_capital, lag(2 3) collapse) /// 
         gmm(L.D.ln_human_capital institutions_L17_20_avg, lag(2 3) equation(level) collapse) ///
         robust twostep
